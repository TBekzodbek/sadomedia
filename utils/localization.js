const TEXTS = {
    uz: {
        ...
        restricted_content: "⚠️ **Cheklov.**\nUshbu platforma (masalan, Facebook) yuklashni taqiqlagan yoki kontent shaxsiy hisoblanadi. Uni bot orqali yuklab bo'lmaydi.",
        ...
        // Dynamic Content
        help_text: "🤖 @SadoMedia_bot\n\n1. 🎵 **Musiqa:** Ijrochi yoki qo'shiq nomini yuboring.\n2. 🎬 **Media:** Havolani (link) yuboring (YouTube, Instagram, TikTok, Facebook, X).",
    ...
    uz_cyrl: {
        ...
        restricted_content: "⚠️ **Чеклов.**\nУшбу платформа (масалан, Facebook) юклашни тақиқлаган ёки контент шахсий ҳисобланади. Уни бот орқали юклаб бўлмайди.",
        ...
        // Dynamic Content
        help_text: "🤖 @SadoMedia_bot\n\n1. 🎵 **Мусиқа:** Ижрочи ёки қўшиқ номини юборинг.\n2. 🎬 **Медиа:** Ҳаволани (link) юборинг (YouTube, Instagram, TikTok, Facebook, X).",
        label_artist: "🎤 Ижрочи",
        label_title: "🎵 Номи",
        label_album: "💿 Альбом",
        label_year: "📅 Йил",
    ...
    ru: {
        ...
        restricted_content: "⚠️ **Ограничение.**\nЭта платформа (например, Facebook) запрещает загрузку или это частный контент. Его нельзя скачать через бота.",
        ...
        // Dynamic Content
        help_text: "🤖 @SadoMedia_bot\n\n1. 🎵 **Музыка:** Отправьте имя исполнителя или название песни.\n2. 🎬 **Медиа:** Отправьте ссылку (YouTube, Instagram, TikTok, Facebook, X).",
    ...
    en: {
        ...
        restricted_content: "⚠️ **Platform Restriction.**\nThis platform (e.g., Facebook) restricts direct downloads or the content is private. It cannot be downloaded via the bot.",
        ...
        // Dynamic Content
        help_text: "🤖 @SadoMedia_bot\n\n1. 🎵 **Music:** Send Artist/Song name.\n2. 🎬 **Media:** Send link (YouTube, Instagram, TikTok, Facebook, X).",
        label_artist: "🎤 Artist",
        label_title: "🎵 Title",
        label_album: "💿 Album",
        label_year: "📅 Year",
